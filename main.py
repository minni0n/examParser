...
with pdfplumber.open(pdf_path) as pdf:
    for page in pdf.pages:
        ...
        for match in matches:
            ...
            # Initialize variables to store community vote distribution
            community_vote_distribution = {}  # Use a dictionary to store answers and their percentages
            ...
            if "Community vote distribution" in question_text:
                # Extract percentages and corresponding answers in the expected format (e.g., "A(85%)")
                ...
                if vote_distribution:
                    for answer, percentage in vote_distribution:
                        ...
                        community_vote_distribution[answer] = percentage  # Store answer and percentage
            ...
            question_data = {
                ...
                "community_vote_distribution": community_vote_distribution  # Include all community votes
            }
